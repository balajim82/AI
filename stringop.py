"""
String is a sequence of characters. In Python, strings are immutable, meaning that once they are created, they cannot be changed.
However, you can perform various operations on strings to create new strings or manipulate existing ones.
